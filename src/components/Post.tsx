          ...
          >
            <g transform="translate(1.4 1.4) scale(2.81 2.81)">
              <path
                ...
                className="transition-all duration-1 group-hover:fill-red-500"
              />
            </g>
          </svg>
...
<div className="flex items-center space-x-1 cursor-pointer group">
  <svg
    ...
    viewBox="0 0 256 256"
    xmlns="http://www.w3.org/2000/svg"
    className="w-6 h-6 transition-all duration-300 fill-white group-hover:fill-gray-400"
  >
  ...
  <span className="font-roboto text-white transition-all duration-300 group-hover:text-gray-400">
    {commentCount}
  </span>
</div>
